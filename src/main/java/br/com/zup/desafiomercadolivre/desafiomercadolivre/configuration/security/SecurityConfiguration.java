...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST,"/api/pagamento-pagseguro/**").permitAll()
                .antMatchers(HttpMethod.POST,"/api/pagamento-paypal/**").permitAll()
                .antMatchers(HttpMethod.POST,"/api/pagamento-pagseguro/**").permitAll()
                .antMatchers(HttpMethod.POST,"/api/notas-fiscais/**").permitAll()
